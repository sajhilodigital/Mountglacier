...
export default function FeaturedDestinations() {
  return (
    <Box className="py-16 px-6 bg-gradient-to-b from-white via-gray-50 to-gray-100 text-center">
      ...
      {/* ✅ Desktop Grid (only visible on md and larger) */}
      <div
      ...
      {/* ✅ Mobile Carousel (only visible below md) */}
      <div className="block md:hidden">
        <div className="flex space-x-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide">
          {destinations.map((dest, index) => (
            <Card
              key={index}
              className="relative min-w-[85%] snap-center rounded-2xl overflow-hidden shadow-md group hover:shadow-xl transition-all duration-500 p-0"
            >
